        ...
        <header><br>
			...
			<div class="container">
				<div class="no-results">
					...
					<div clas="content">
				<br/><br/>
				&emsp;&emsp;&emsp; <p style= "color:white">Citizens can report complaints / grievances by clicking and uploading a photograph of the issue to be reported.
				All the complaints submitted will be processed and the issues will be solved as soon as possible. 
					</p>
				<br/><br/>
				</section>
					</div>
